...
const khoaHocs=[
    ...
    {id:2,tenKhoaHoc:"Lập trình ASP.NET",donGia:240000,giaoVien:"Lê Hoàng"},
    {id:3,tenKhoaHoc:"Lập trình hướng đối tượng",donGia:230000,giaoVien:"Lê Lộc"},
    {id:4,tenKhoaHoc:"Lập trình PHP",donGia:220000,giaoVien:"Lê Huy"},
];
app.use(bodyParser.urlencoded({extended:true}));//thay bằng express.urlencoded
